...
import '../assets/css/RouteDetail.css';
...
export default function RouteDetail() {
  ...
  return (
    <>
      ...
      {/* 🟨 Contenido principal */}
      <main className="route-detail container py-5">
        <motion.div
        ...
        >
          <div className="row">
            <div className="col-md-8">
              ...
              <h1 className="mb-4 fw-bold text-primary">{city.name}</h1>
              ...
              <div className="card mb-4 shadow-sm">
                <div className="card-body">
                  <h5 className="card-title text-primary">Información General</h5>
              ...
              <div className="card mb-4 shadow-sm">
                <div className="card-body">
                  <h5 className="card-title text-primary">Puntos de Interés</h5>
            ...
            <div className="col-md-4">
              <div className="card sticky-top shadow-sm" style={{ top: '6rem' }}>
                <div className="card-body">
                  <h5 className="card-title text-primary">Reservar esta ruta</h5>
